    ...
    <section className="section relative overflow-hidden lg:mb-0">
      <div className="container relative z-30">
        ...
        <p>
          ...
          einen Server in den USA und speichert die Daten dort. Die Verarbeitung
          geschieht durch den Diensteanbieter (oben genannt), der Betreiber
          dieser Homepage hat keinen Einfluss auf die Übertragung der Daten.
        </p>
        <p>
          ...
          Interesse) der DSGVO. Die Nutzung von Google Maps erhöht die
          Auffindbarkeit der Orte, welche auf unserer Webseite bereitgestellt
          werden.
        </p>
        <p>
        ...
        <p>
          ...
          gegen das Datenschutzrecht passiert sind, so haben Sie die
          Möglichkeit, sich bei uns (office@blitzblank-bregenz.at) oder der
        ...
        <p>
          <span className="font-bold">Herausgeber</span> Milan Colic
          <br />
          <span className="font-bold">Geschäftsinhaber</span> Milan Colic
          <br />
          <span className="font-bold">Geschäftsführerin</span> Meri Colic
          <br />
