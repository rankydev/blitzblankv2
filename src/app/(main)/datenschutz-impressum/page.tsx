...
const DatenschutzImpressum = () => {
  return (
    <section className="section relative overflow-hidden lg:mb-0">
      <div className="container relative z-30">
        <h3 className="my-8">Datenschutzerklärung</h3>
        <p>
          In folgender Datenschutzerklärung informieren wir Sie über die
          wichtigsten Aspekte der Datenverarbeitung im Rahmen unserer Webseite. Wir
          erheben und verarbeiten personenbezogene Daten nur auf Grundlage der
          gesetzlichen Bestimmungen (Datenschutzgrundverordnung,
        ...
        <p>
          ...
          erfasst. Dies ist technisch bedingt und stellt somit ein berechtigtes
          Interesse iSv Art 6 Abs 1 lit f DSGVO.
        </p>
        <h5 className="mt-8">Kontakt mit uns</h5>
        <p>
        ...
        <h5 className="mt-8">Google Maps</h5>
        <p>
        ...
        <p>
          ...
          Server in den USA und speichert die Daten dort. Die Verarbeitung
          geschieht durch den Diensteanbieter (oben genannt), der Betreiber dieser
          Homepage hat keinen Einfluss auf die Übertragung der Daten.
        </p>
        <p>
          Die Datenverarbeitung erfolgt auf Basis der gesetzlichen Bestimmungen
          des § 96 Abs 3 TKG sowie des Art 6 Abs 1 lit f (berechtigtes Interesse)
          der DSGVO. Die Nutzung von Google Maps erhöht die Auffindbarkeit der
          Orte, welche auf unserer Webseite bereitgestellt werden.
        </p>
        <p>
        ...
        <h5 className="mt-8">Google Fonts</h5>
        <p>
        ...
        <h5 className="mt-8">Ihre Rechte als Betroffener</h5>
        <p>
        ...
        <p>
          ...
          sich bei uns (office@blitzblank-bregenz.at) oder der
          Datenschutzbehörde zu beschweren.
        </p>
        <h5 className="mt-8">Sie erreichen uns unter folgenden Kontaktdaten:</h5>
        <p>
          <b>Webseitenbetreiber:</b> Milan Colic
          <br />
          <b>Telefonnummer:</b> 0043557443714
          <br />
          <b>Email:</b> office@blitzblank-bregenz.at
        </p>
        <p>
          Quelle:{' '}
          <b>
        ...
        <h3 className="mt-12 mb-8">Impressum</h3>
        <p>
        <span className="font-bold">Herausgeber</span> Milan Colic<br />
        <span className="font-bold">Geschäftsinhaber</span>Milan Colic<br />
        <span className="font-bold">Geschäftsführerin</span>Meri Colic<br />
        Max-Haller-Straße 2, 6900 Bregenz<br />
        T +43 5574 43714<br />
        Zuständiges Finanzamt: Bregenz<br />
        UID ATU63811049<br />
        Firmenbuch LG Feldkirch, FN303205 S
        </p>
      </div>
    </section>
  );
...
export default DatenschutzImpressum;
